...
WAIT_VALIDATE_AFTER_INDEXATION_DAYS = env.int('WAIT_VALIDATE_AFTER_INDEXATION_DAYS', 3)
WAIT_VALIDATE_INDEXED_PAGE_DAYS = env.int('WAIT_VALIDATE_INDEXED_PAGE_DAYS', 15)
